...
from .serializers import RegisterSerializer, EmailVerificationSerializer, LoginSerializer, RolesSerializer, \
    ResetPasswordWithEmailSerializer, SetNewPasswordSerializer, SocialLoginSerializer, SocialSignupSerializer, \
    MeAPIViewSerializer, PasswordTokenCheckSerializer, UsersSerializer
